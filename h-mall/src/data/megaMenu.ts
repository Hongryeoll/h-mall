    ...
    sections: [
      {
        ...
        links: [
          ...
          { label: '냄비,팬,솥',      slug: 'pots-pans',            href: '/category/list?category=KITCHEN&section=kitchen&subsection=pots-pans' },
          ...
          { label: '주방잡화',        slug: 'kitchen-goods',        href: '/category/list?category=KITCHEN&section=kitchen&subsection=kitchen-goods' },
          { label: '주방수납',        slug: 'storage',              href: '/category/list?category=KITCHEN&section=kitchen&subsection=storage' },
          { label: '수납정리',        slug: 'organization',         href: '/category/list?category=KITCHEN&section=kitchen&subsection=organization' },
